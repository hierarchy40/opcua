...
[![GitHub](https://github.com/hierarchy40/opcua/workflows/gopuca/badge.svg)](https://github.com/hierarchy40/opcua/actions)
[![Go Reference](https://pkg.go.dev/badge/github.com/hierarchy40/opcua.svg)](https://pkg.go.dev/github.com/hierarchy40/opcua)
[![License](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/hierarchy40/opcua/blob/master/LICENSE)
[![Version](https://img.shields.io/github/tag/gopcua/opcua.svg?color=blue&label=version)](https://github.com/hierarchy40/opcua/releases)
...
```sh
# install library
go get -u github.com/hierarchy40/opcua
...
The [Current State](https://github.com/hierarchy40/opcua/wiki/Current-State) was moved
to the [Wiki](https://github.com/hierarchy40/opcua/wiki).
...
The [Gopcua Team](https://github.com/hierarchy40/opcua/graphs/contributors).
...
[MIT](https://github.com/hierarchy40/opcua/blob/master/LICENSE)
